            ...
            <div className="bg-white h-16 justify-between items-center mx-auto px-4 flex">
              ...
              <div className="lg:block mr-auto ml-40 hidden relative max-w-xs">
                ...
                <input
                  ...
                  type="search"
                  className="border border-gray-300 focus:ring-gray-600
                focus:border-gray-600 sm:text-md w-96 rounded-2xl pt-2 pb-2 pl-10 px-3 py-2"
                />
              </div>
              <div className="md:space-x-6 justify-end items-center ml-auto flex space-x-3">
                ...
                <div className="relative">
                  ...
                  <p
                    className="px-1.5 py-0.5 font-semibold text-xs items-center bg-red-600 text-white rounded-full inline-flex
                  absolute -top-px -right-3"
                  >
                    9+
                  </p>
                </div>
